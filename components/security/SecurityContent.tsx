...
import { Shield, Globe, Server, ChevronDown, Eye, Database, Gavel } from 'lucide-react';
...
export default function SecurityContent() {
    return (
        <div className="min-h-screen bg-background text-foreground font-poppins pt-20">
            {/* Hero Section */}
            <SectionWrapper id="security-hero" className="py-24 md:py-32 text-center relative overflow-hidden">
                ...
                <svg className="absolute inset-0 w-full h-full opacity-30 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0,100 Q500,200 1000,100 T2000,100" stroke="#E5E5E5" strokeWidth="1" fill="none" />
                    <path d="M0,300 Q600,400 1200,300 T2400,300" stroke="#E5E5E5" strokeWidth="0.5" fill="none" />
                    <path d="M0,600 Q400,500 800,600 T1600,600" stroke="#E5E5E5" strokeWidth="0.5" fill="none" />
                </svg>
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <p className="text-neutral-500 font-medium mb-4 uppercase tracking-widest text-sm">Security First</p>
            ...
            <SectionWrapper id="security-features" className="py-24 bg-cream border-y border-border-subtle">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <p className="text-neutral-500 text-sm uppercase tracking-widest mb-2">Core Pillars</p>
                        <h2 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-4">Enterprise-Ready Architecture</h2>
                    </div>

                    <div className="grid md:grid-cols-3 gap-0 border border-border-subtle rounded-xl overflow-hidden bg-white backdrop-blur-sm relative">
                        {/* Card 1 */}
                        <div className="p-8 md:p-12 border-b md:border-b-0 md:border-r border-border-subtle relative group">
                            <div className="mb-6 p-3 bg-cream rounded-lg w-fit group-hover:bg-blue-50 transition-colors">
                                <Shield className="w-8 h-8 text-neutral-900 group-hover:text-blue-600 transition-colors" />
                            </div>
                            <h3 className="text-xl font-bold text-neutral-900 mb-4">World-Class Security Ops</h3>
                        ...
                        {/* Card 2 */}
                        <div className="p-8 md:p-12 border-b md:border-b-0 md:border-r border-border-subtle relative group">
                            <div className="mb-6 p-3 bg-cream rounded-lg w-fit group-hover:bg-purple-50 transition-colors">
                                <Globe className="w-8 h-8 text-neutral-900 group-hover:text-purple-600 transition-colors" />
                            </div>
                            <h3 className="text-xl font-bold text-neutral-900 mb-4">Global Data Residency</h3>
                            <p className="text-neutral-600 leading-relaxed">
                        ...
                        <div className="p-8 md:p-12 relative group">
                            <div className="mb-6 p-3 bg-cream rounded-lg w-fit group-hover:bg-green-50 transition-colors">
                                <Database className="w-8 h-8 text-neutral-900 group-hover:text-green-600 transition-colors" />
                            </div>
                            <h3 className="text-xl font-bold text-neutral-900 mb-4">Zero-Training Guarantee</h3>
                            <p className="text-neutral-600 leading-relaxed">
                        ...
                        {/* Card 4 - Row 2 */}
                        <div className="p-8 md:p-12 border-b md:border-b-0 md:border-r md:border-t border-border-subtle relative group">
                            <div className="mb-6 p-3 bg-cream rounded-lg w-fit group-hover:bg-neutral-100 transition-colors">
                                <Server className="w-8 h-8 text-neutral-900" />
                            </div>
                            <h3 className="text-xl font-bold text-neutral-900 mb-4">Scalable Enterprise Controls</h3>
                            <p className="text-neutral-600 leading-relaxed">
                        ...
                        <div className="p-8 md:p-12 border-b md:border-b-0 md:border-r md:border-t border-border-subtle relative group">
                            <div className="mb-6 p-3 bg-cream rounded-lg w-fit group-hover:bg-neutral-100 transition-colors">
                                <Gavel className="w-8 h-8 text-neutral-900" />
                            </div>
                            <h3 className="text-xl font-bold text-neutral-900 mb-4">Binding Legal Assurances</h3>
                            <p className="text-neutral-600 leading-relaxed">
                        ...
                        {/* Card 6 - Row 2 */}
                        <div className="p-8 md:p-12 md:border-t border-border-subtle relative group">
                            <div className="mb-6 p-3 bg-cream rounded-lg w-fit group-hover:bg-neutral-100 transition-colors">
            ...
            {/* FAQ Section */}
            <SectionWrapper id="security-faq" className="py-24 bg-cream border-t border-border-subtle">
                <div className="container mx-auto px-6 max-w-3xl">
                    <h2 className="text-3xl font-bold text-neutral-900 mb-12 text-center">Common Security Questions</h2>
            ...
            {/* CTA */}
            <SectionWrapper id="security-cta" className="py-24 border-t border-border-subtle">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <h3 className="text-3xl font-bold text-neutral-900 max-w-xl">
    ...
    return (
        <div className="border-b border-border-subtle">
            <button
                ...
                className="w-full py-6 flex items-center justify-between text-left text-neutral-700 hover:text-neutral-900 transition-colors"
            >
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <p className="pb-6 text-neutral-500 leading-relaxed">
                            {answer}
                        </p>
                    </motion.div>
                )}
